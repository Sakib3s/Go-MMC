...
// Accordion Services
function gommc_services_accordion_init() {
...
(function($) {
    ...
    function gommc_ajax_query(grid, section, request_data) {
        if (wait_load) return;
        wait_load = true;
    ...
    function gommc_ajax_init(section) {
        offset_items = 0;
        ...
        if (infinity_item.length) {
            ...
            if (jQuery(infinity_item).is_visible()) {
                gommc_ajax_query(grid, section, request_data);
            }
            var lastScrollTop = 0;
...
function gommc_scroll_animation(){
...
function gommc_blog_masonry_init () {
...
function gommc_circuit_service() {
...
function gommc_dynamic_styles() {
    var style = jQuery('#gommc-footer-inline-css');
 ...
 */
function gommc_slick_navigation_init (){
  jQuery.fn.gommc_slick_navigation = function (){
...
// rt image comparison
function gommc_image_comparison() {
...
function gommc_message_anim_init() {
    jQuery('body').on('click', '.message_close_button', function (e) {
        jQuery(this).closest('.gommc_module_message_box.closable').slideUp(350);
    });
}

function gommc_mobile_header() {
...
function gommc_page_title_parallax() {
...
function gommc_extended_parallax() {
...
function gommc_portfolio_parallax() {
...
function gommc_particles_custom() {
...
function gommc_particles_image_custom() {
...
// rt Progress Bars
function gommc_progress_bars_init(e) {
...
function gommc_side_panel_init() {
...
function gommc_text_background() {
...
function gommc_init_timeline_appear() {
...
function gommc_woocommerce_helper(){
...
function gommc_woocommerce_login_in() {
...
function gommc_woocommerce_mini_cart(){
