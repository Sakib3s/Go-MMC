...
if (!class_exists('GoMMC_Single_Post')) {
    /**
     * @package gommc\core\class
     * @author MMC 
     * @since 1.0.0
     */
    class GoMMC_Single_Post
    {
        /**
         * @var GoMMC_Single_Post
         */
        ...
        public function render_featured_image_as_background(
            ...
            $featured_image = GoMMC::get_mb_option('featured_image_type', 'mb_featured_image_conditional', 'custom');
            if ('replace' === $featured_image) {
                $featured_image_replace = GoMMC::get_mb_option('featured_image_replace', 'mb_featured_image_conditional', 'custom');
            }
            ...
            if ($media && $show_media) {
                ...
                $default_bg = GoMMC::get_option('post_single_layout_3_bg_image');
              ...
              <?php  }
                ...
                if ($this->show_meta_comments) {
                    ...
                    echo '<span class="comments_post"> <i class="flaticon-chat"></i>',
                        '<a href="', esc_url(get_comments_link()), '" title="', esc_attr__('Leave a reply', 'gommc'), '">',
                            esc_html($comments_num),
                            ' ',
                            esc_html(_n('Comment', 'Comments', $comments_num, 'gommc')),
                        '</a>',
                    '</span>';
                }
        ...
        public function render_excerpt(
            ...
            if ($trim || GoMMC::get_option('blog_post_listing_content')) {
                ...
                $post_content = GoMMC::modifier_character($content_strip_tags, $symbol_count, '...');
            }
