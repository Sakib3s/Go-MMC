...
$trim = true;
if (!$tpc_blog_atts) {
    $opt_likes = GoMMC_Theme_Helper::get_option('blog_list_likes');
    $opt_share = GoMMC_Theme_Helper::get_option('blog_list_share');
    $opt_meta_author = GoMMC_Theme_Helper::get_option('blog_list_meta_author');
    $opt_meta_comments = GoMMC_Theme_Helper::get_option('blog_list_meta_comments');
    $opt_meta_categories = GoMMC_Theme_Helper::get_option('blog_list_meta_categories');
    $opt_meta_date = GoMMC_Theme_Helper::get_option('blog_list_meta_date');
    $opt_read_more = GoMMC_Theme_Helper::get_option('blog_list_read_more');
    ...
    $tpc_blog_atts = [
        ...
        'blog_layout' => 'grid',
        // Content
        'blog_columns' => GoMMC_Theme_Helper::get_option('blog_list_columns') ?: '12',
        'hide_media' => GoMMC_Theme_Helper::get_option('blog_list_hide_media'),
        'hide_content' => GoMMC_Theme_Helper::get_option('blog_list_hide_content'),
        'hide_blog_title' => GoMMC_Theme_Helper::get_option('blog_list_hide_title'),
        'hide_all_meta' => GoMMC_Theme_Helper::get_option('blog_list_meta'),
        ...
        'content_letter_count' => GoMMC_Theme_Helper::get_option('blog_list_letter_count') ?: '85',
...
while ($query->have_posts()) : $query->the_post();
    ...
    ?>
    <div class="blog-post <?php echo esc_attr($blog_item_classes); ?>"<?php echo GoMMC_Theme_Helper::render_html($blog_attr);?>>
