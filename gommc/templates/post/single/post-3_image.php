...
$meta_date = $meta_data = [];
if (!$hide_all_meta) {
	$meta_date['date'] = !GoMMC_Theme_Helper::get_option('single_meta_date');
...
$page_title_padding = GoMMC_Theme_Helper::get_mb_option('single_padding_layout_3', 'mb_post_layout_conditional', 'custom');
...
$apply_animation = GoMMC_Theme_Helper::get_mb_option('single_apply_animation', 'mb_post_layout_conditional', 'custom');
	...
	<div class="item_wrapper">
		<div class="blog-post_content"><?php
		    ...
		    <div class="tpc-container">
			    <div class="row">
				    <div class="content-container tpc_col-12"<?php echo GoMMC::render_html($data_attr_content); ?>><?php

				        // Title ?>
				        <h1 class="blog-post_title"><?php echo get_the_title(); ?></h1><?php

				         // Breadcrumb ?>
				        <?php gommc_breadcrumb_trail(); ?>
