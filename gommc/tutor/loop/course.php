...
$tutor_archive_layout = GoMMC_Theme_Helper::get_mb_option('tutor_archive_layout');
$tutor_see_more_text = GoMMC_Theme_Helper::get_mb_option('tutor_see_more_text');
$tutor_archive_hide_media = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_media');
$tutor_archive_hide_categories = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_categories');
$tutor_archive_hide_categories_popup = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_categories_popup');
$tutor_archive_hide_price = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_price');
$tutor_archive_hide_price_popup = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_price_popup');
$tutor_archive_hide_title = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_title');
$tutor_archive_hide_title_popup = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_title_popup');
$tutor_archive_hide_created_by = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_created_by');
$tutor_archive_hide_created_by_popup = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_created_by_popup');
$tutor_archive_hide_lessons = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_lessons');
$tutor_archive_hide_lessons_popup = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_lessons_popup');
$tutor_archive_hide_lessons_text = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_lessons_text');
$tutor_archive_hide_lessons_text_popup = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_lessons_text_popup');
$tutor_archive_hide_duration = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_duration');
$tutor_archive_hide_duration_popup = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_duration_popup');
// $tutor_archive_hide_topic_text = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_topic_text');
// $tutor_archive_hide_topic_text_popup = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_topic_text_popup');
$tutor_archive_hide_preview_btn = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_preview_btn');
$tutor_archive_hide_enroll_btn = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_enroll_btn');
$tutor_enroll_now_text = GoMMC_Theme_Helper::get_mb_option('tutor_enroll_now_text');
$tutor_archive_enroll_btn_switch = GoMMC_Theme_Helper::get_mb_option('tutor_archive_enroll_btn_switch');
$tutor_archive_hide_excerpt_content = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_excerpt_content');
$tutor_archive_hide_excerpt_content_popup = GoMMC_Theme_Helper::get_mb_option('tutor_archive_hide_excerpt_content_popup');
$tutor_free_text = GoMMC_Theme_Helper::get_mb_option('tutor_free_text');
$tutor_enrolled_text = GoMMC_Theme_Helper::get_mb_option('tutor_enrolled_text');
$tutor_completed_text = GoMMC_Theme_Helper::get_mb_option('tutor_completed_text');

$tutor_tf_hover_popup_type = GoMMC_Theme_Helper::get_mb_option('tutor_tf_hover_popup_type');
    ?>
    ...
    <?php if ($tutor_archive_layout == '1'): ?>
            ...
            <?php  if ($tutor_tf_hover_popup_type == 'show_content_popup') : ?>
                <div class="course__popup-wrap">
                    ...
                    <div class="btn__wrap">
                        <a class="btn__a" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Preview This Course', 'gommc' ); ?></a>
                    </div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
