...
?>
	...
	<?php if (1>1) { ?>
        ...
        <header class="page-header">
            <h1 class="page-title vczapi-archive-page-title"><?php echo esc_html__( 'Archives: Zoom Meetings', 'gommc' ); ?></h1>
        </header><!-- .page-header -->
	<?php } ?>
		<?php
		/**
		...
		if ( have_posts() ) {
            ...
            <div class="gommc__vczapi-pagination">
				<?php echo GoMMC::pagination(); ?>
            </div>
			<?php
		} else {
			echo "<p class='vczapi-no-meeting-found'>" . esc_html__( 'No Meetings found.', 'gommc' ) . "</p>";
		}
