...
?>
    ...
    <h2 class="nav-tab-wrapper">
        ...
        // printf( '<a href="%s" class="nav-tab">%s</a>', admin_url( 'admin.php?page=gommc-theme-plugins' ), esc_html__( 'Theme Plugins', 'gommc' ) );
    ...
    <div class="gommc-system-stats">
        ...
        <h3><?php esc_html_e( 'Active Plugins (', 'gommc' ); ?><?php echo esc_attr(count( $plugins_counts )) . ')' ?></h3>
